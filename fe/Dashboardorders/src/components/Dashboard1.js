...
import { fetchReport, fetchgetTopMovies } from '../api/movieApi';
function Dashboard1() {
                        ...
                        {topmovies.map((a,index)=>(
                          ...
                          {/* <ListGroup.Item>
                            <div className="d-flex align-items-center">
                              ...
                              <span style={{ marginLeft: "10px", color: "black" }}>Movie 3</span>
                            </div>
                          </ListGroup.Item>
                          <ListGroup.Item>
                            <div className="d-flex align-items-center">
                              <div className="legend-color" style={{ backgroundColor: "#E2F0CB", width: "30px", height: "15px" }}></div>
                              <span style={{ marginLeft: "10px", color: "black" }}>Movie 4</span>
                            </div>
                          </ListGroup.Item> */}
                        </ListGroup>
                        ))}
