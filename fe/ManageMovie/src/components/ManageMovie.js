...
e.preventDefault();
try{
const response = await axios.post(`${baseUrl}/api/movie/createMovie`,{
},{
headers:{
...
<div className="container-scroller">
    ...
    <div className="container-fluid page-body-wrapper">
            ...
            <div class="content-wrapper" style={{backgroundColor: "white", top: "50px"}}>
                 <div class="page-header">
                                             ...
                                             <div style={{textAlign: 'center', marginTop: '20px'}}>
                                                  <Button onClick={
                                                      handleCreateMovie} variant="success">Add New Movie</Button>
                                              </div>
                                              <FlexContainer>
                                                  <Pagination
        ...
        <StyledDialog
            ...
            <DialogActions>
                <Button onClick={
                        handleOnCloseConfirmationDialog} color="primary">
                        Cancel
            </Button>
            <Button onClick={
                    handleDeleteUser} color="primary">
                    Delete
        </Button>
    </DialogActions>
</StyledDialog>
